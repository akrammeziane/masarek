...
const UNIVERSITY_CATALOGUE = [
  { id: 'USTHB', nameAr: 'جامعة العلوم والتكنولوجيا هواري بومدين (USTHB)', wilaya: 'الجزائر', website: 'https://www.usthb.dz', domains: ['A', 'B', 'C', 'D', 'E'] },
  { id: 'U001', nameAr: 'جامعة الجزائر 1 بن يوسف بن خدة', wilaya: 'الجزائر', website: 'https://www.univ-alger.dz', domains: ['P', 'G', 'F', 'I'] },
  { id: 'U002', nameAr: 'جامعة الجزائر 2 أبو القاسم سعد الله', wilaya: 'الجزائر', website: 'https://www.univ-alger2.dz', domains: ['I', 'L', 'M', 'H'] },
  { id: 'ESI', nameAr: 'المدرسة الوطنية العليا للإعلام الآلي (ESI)', wilaya: 'الجزائر', website: 'https://www.esi.dz', domains: ['C', 'A'] },
  { id: 'ENP', nameAr: 'المدرسة الوطنية متعددة التقنيات (ENP)', wilaya: 'الجزائر', website: 'https://www.enp.edu.dz', domains: ['A', 'N'] },
  { id: 'U005_CST', nameAr: 'جامعة الإخوة منتوري قسنطينة 1', wilaya: 'قسنطينة', website: 'https://www.umc.edu.dz', domains: ['A', 'B', 'C', 'G', 'I', 'L'] },
  { id: 'U007_ORA', nameAr: 'جامعة وهران 1 أحمد بن بلة', wilaya: 'وهران', website: 'https://www.univ-oran1.dz', domains: ['P', 'A', 'F', 'I', 'L'] },
  { id: 'U008_ORA', nameAr: 'جامعة وهران 2 محمد بن أحمد', wilaya: 'وهران', website: 'https://www.univ-oran2.dz', domains: ['G', 'F', 'H', 'I'] },
  { id: 'U013_SET', nameAr: 'جامعة فرحات عباس سطيف 1', wilaya: 'سطيف', website: 'https://www.univ-setif.dz', domains: ['A', 'B', 'C', 'P', 'F'] },
  { id: 'U015_TLM', nameAr: 'جامعة أبي بكر بلقايد تلمسان', wilaya: 'تلمسان', website: 'https://www.univ-tlemcen.dz', domains: ['P', 'A', 'G', 'F', 'D'] },
  { id: 'U016_TIZ', nameAr: 'جامعة مولود معمري تيزي وزو', wilaya: 'تيزي وزو', website: 'https://www.ummto.dz', domains: ['A', 'P', 'F', 'H', 'L'] },
  { id: 'U018_ANN', nameAr: 'جامعة باجي مختار عنابة', wilaya: 'عنابة', website: 'https://www.univ-annaba.dz', domains: ['A', 'B', 'P', 'G', 'L'] },
  { id: 'U011_BAT', nameAr: 'جامعة الحاج لخضر باتنة 1', wilaya: 'باتنة', website: 'https://www.univ-batna.dz', domains: ['P', 'A', 'F', 'G'] },
  { id: 'U019_BLD', nameAr: 'جامعة سعد دحلب البليدة 1', wilaya: 'البليدة', website: 'https://www.univ-blida.dz', domains: ['P', 'A', 'C', 'D'] },
  { id: 'U009_BJA', nameAr: 'جامعة عبد الرحمن ميرة بجاية', wilaya: 'بجاية', website: 'https://www.univ-bejaia.dz', domains: ['A', 'B', 'F', 'H'] },
  { id: 'U026_ORG', nameAr: 'جامعة قاصدي مرباح ورقلة', wilaya: 'ورقلة', website: 'https://www.univ-ouargla.dz', domains: ['A', 'F', 'G', 'I'] },
  { id: 'U017_BSK', nameAr: 'جامعة محمد خيضر بسكرة', wilaya: 'بسكرة', website: 'https://www.univ-biskra.dz', domains: ['A', 'C', 'F', 'D'] },
]

const DOMAIN_AR: Record<string, string> = {
  A: 'العلوم والتكنولوجيا', B: 'علوم المادة', C: 'الرياضيات والإعلام الآلي',
  D: 'علوم الطبيعة والحياة', E: 'علوم الأرض', F: 'العلوم الاقتصادية والتسيير',
  G: 'الحقوق والعلوم السياسية', H: 'اللغات والترجمة', I: 'العلوم الإنسانية والاجتماعية',
  J: 'النشاطات البدنية والرياضية', K: 'الفنون', L: 'الآداب العربية',
  M: 'الآداب', N: 'العمارة والعمران', P: 'العلوم الطبية',
}
...
function getMatchingUniversities(recs: Recommendation[]) {
  ...
  return UNIVERSITY_CATALOGUE
    .map(u => {
      ...
      return { ...u, matchCount: matched.length, matchedLabels: matched.map(d => DOMAIN_AR[d] ?? d).slice(0, 2) }
    })
    ...
    <div className="min-h-screen bg-[#F4F6F9]" dir="rtl">
          ...
          <div className="flex items-center gap-2">
            {canRetake ? (
              <Link href="/assessment?reset=1">
                <button className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-semibold border border-[#E2E8F0] text-gray-600 hover:border-[#006233] hover:text-[#006233] transition-all duration-200">
                  <RefreshCw className="w-3.5 h-3.5" />
                  <span className="hidden sm:inline">إعادة ({attemptsLeft} متبقي)</span>
              ...
              <span className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-semibold border border-[#E2E8F0] text-gray-400 cursor-not-allowed opacity-60">
                <RefreshCw className="w-3.5 h-3.5" /> بعد {hoursLeft}س
              </span>
            )}
            <Link href="/dashboard">
              <button className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-semibold border border-[#006233] text-[#006233] hover:bg-[#006233] hover:text-white transition-all duration-200">
      ...
      <main className="max-w-5xl mx-auto px-4 py-6 md:py-8">
        ...
        <div className="text-center mb-6 md:mb-8">
          <div className="w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-[#006233]/10 flex items-center justify-center mx-auto mb-3">
            <Target className="w-7 h-7 md:w-8 md:h-8 text-[#006233]" />
          </div>
          <h1 className="text-xl md:text-2xl font-bold text-[#0B2340] mb-1">نتائج تحليل الذكاء الاصطناعي</h1>
          <p className="text-gray-500 text-sm">بناءً على إجاباتك، حلّل الذكاء الاصطناعي ملفك وأعدّ توصياتك الشخصية</p>
        </div>

        {/* TOP MATCH BANNER */}
        {hasData && top && (
          <div className="rounded-2xl p-5 md:p-6 text-white mb-6 md:mb-8 shadow-lg" style={{ background: 'linear-gradient(135deg, #006233 0%, #004d28 100%)' }}>
            <div className="flex flex-col gap-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <h2 className="text-lg md:text-xl font-bold mb-0.5 leading-snug">{top.nameAr}</h2>
                  {top.nameFr && top.nameFr !== top.nameAr && (
                    <p className="text-white/70 text-sm mb-2">{top.nameFr}</p>
                  )}
                  <div className="flex flex-wrap gap-2">
                    <span className="bg-white/15 text-white text-xs px-2.5 py-1 rounded-full">⏱ {top.durationYears} سنوات</span>
                    {top.minGrade != null && (
                      <span className="bg-white/15 text-white text-xs px-2.5 py-1 rounded-full">📊 {top.minGrade}/20</span>
                    )}
                ...
                <div className="flex flex-wrap gap-1.5">
                  {top.reasons.map(r => (
                    <span key={r} className="flex items-center gap-1 bg-white/10 text-white/90 text-xs px-2 py-0.5 rounded-full">
                      <CheckCircle className="w-3 h-3 text-[#C8A84B] shrink-0" /> {r}
                    </span>
                  ))}
                </div>
              )}
              ...
              <CardContent className="p-4 md:p-5">
                ...
                <div className="space-y-2.5">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-medium text-[#0B2340]">{BAC_SERIES_LABELS[answers.bacSeries] ?? answers.bacSeries ?? '—'}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-[#0B2340] text-sm mt-0.5">{WORK_ENV_LABELS[answers.workEnv] ?? answers.workEnv ?? '—'}</p>
                  </div>
                ...
                <div className="space-y-3">
                  ...
                  {topStrength && (
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-medium text-[#0B2340] text-right">
                        {{ logic:'التحليل المنطقي', creativity:'الإبداع', comms:'التواصل', leadership:'القيادة', math:'الرياضيات', writing:'الكتابة', problem:'حل المشكلات', org:'التنظيم' }[topStrength[0]] ?? topStrength[0]}
        ...
        {Object.keys(answers.strengths).length > 0 && (
          <Card className="border-[#E2E8F0] mb-6 md:mb-8">
        ...
        <div className="space-y-4 mb-10">
          {recommendations.map((rec) => {
            ...
            return (
              ...
              >
                <button className="w-full text-right" onClick={() => setExpandedId(isExpanded ? null : rec.id)}>
                  <CardContent className="p-4 md:p-5">
                    <div className="flex items-center gap-3 md:gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex flex-wrap items-center gap-2 mb-1">
                          ...
                          <Badge variant="outline" className="text-xs border-[#E2E8F0] text-gray-500 hidden sm:inline-flex">{rec.fieldAr}</Badge>
                        </div>
                        <h3 className="font-bold text-[#0B2340] text-sm md:text-base leading-snug">{rec.nameAr}</h3>
                        {rec.nameFr && rec.nameFr !== rec.nameAr && (
                      ...
                      <div className="flex flex-wrap gap-1.5 mt-3">
                        {rec.reasons.map(r => (
                          <span key={r} className="flex items-center gap-1 text-xs bg-[#F4F6F9] text-gray-600 px-2 py-0.5 rounded-full border border-[#E2E8F0]">
                            <CheckCircle className="w-3 h-3 text-[#006233] shrink-0" /> {r}
                          </span>
                        ))}
                      </div>
                    )}
                ...
                {isExpanded && (
                  <div className="border-t border-[#E2E8F0] px-4 md:px-5 pb-5 pt-4 bg-[#FAFBFC]">
                    <p className="text-gray-600 text-sm mb-4">{rec.descriptionAr}</p>
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-4 text-sm">
                      <div className="flex items-center gap-2 text-gray-600">
                        <Clock className="w-4 h-4 text-[#006233] shrink-0" />
                        <span>مدة: <span className="font-semibold text-[#0B2340]">{rec.durationYears} سنوات</span></span>
                      </div>
                      <div className="flex items-center gap-2 text-gray-600">
                        <Star className="w-4 h-4 text-[#C8A84B] shrink-0" />
                        <span>الحد: <span className="font-semibold text-[#0B2340]">{rec.minGrade ?? '—'}/20</span></span>
                      </div>
                      {rec.admissionPriority && (
                        <div className="flex items-center gap-2 text-gray-600">
                          <CheckCircle className="w-4 h-4 text-[#006233] shrink-0" />
        ...
        {hasData && (() => {
          ...
          return matchingUnis.length > 0 ? (
            <div className="mt-8">
              ...
              <p className="text-sm text-gray-500 mb-4">مؤسسات جامعية جزائرية رسمية تقدم التخصصات الموصى بها</p>
                    ...
                    <CardContent className="p-4">
                      <div className="flex items-start gap-2.5 mb-2">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-xs text-gray-400 mt-0.5 flex items-center gap-1">
                            <MapPin className="w-3 h-3 shrink-0" /> {u.wilaya}
                          </p>
                        </div>
                      </div>
                      ...
                      {u.website && (
                        <a href={u.website} target="_blank" rel="noopener noreferrer"
                          ...
                          <ExternalLink className="w-3 h-3 shrink-0" /> الموقع الرسمي
                        </a>
                      )}
                    </CardContent>
                  </Card>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
          <Card className="bg-[#006233]/5 border-[#006233]/20">
            <CardContent className="p-4 md:p-5 flex items-center gap-4">
              ...
              <Link href="/explorer?from=dashboard" className="shrink-0">
          ...
          <Card className="bg-[#0B2340]/5 border-[#0B2340]/20">
            <CardContent className="p-4 md:p-5 flex items-center gap-4">
              ...
              <Link href="/assessment?reset=1" className="shrink-0">
